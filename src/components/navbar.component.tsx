    ...
    <div className="grid grid-cols-[1fr_100px]">
      ...
      <div className="flex flex-col justify-center">
        ...
        <nav className="flex flex-col items-center bg-white-transparent gap-8 p-8 pt-2 pb-2 rounded-full w-10">
          <ButtonNavbar path="/" icon={<House size={'1.3rem'} />} />
          <ButtonNavbar path="/aboutme" icon={<BookOpenText size={'1.3rem'} />}/>
          <ButtonNavbar path="/skills" icon={<Zap size={'1.3rem'} />}/>
          <ButtonNavbar path="/projects"  icon={<BriefcaseBusiness size={'1.3rem'} />}/>
        </nav>
      </div>
    </div>
  );
